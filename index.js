...
let player = new Player(canvas.width / 2, canvas.height / 2, 10, "yellow");
let projectiles = [];
let enemies = [];
let particles = [];
...
const projectile = new Projectile(50, 50, 30, "red", { x: 3, y: 3 });
projectile.draw();
...
window.addEventListener("click", (event) => {
  ...
  const projectile = new Projectile(player.x, player.y, 2, "red", velocity);
